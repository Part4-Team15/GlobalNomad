      ...
      <div className="relative h-screen flex flex-col px-8 py-12 gap-6">
        <div className="w-full flex justify-between">
          ...
          <button type="button" onClick={handleModalClose}>
            <img className="w-10 cursor-pointer" src="/assets/x_btn.svg" alt="Close Box Button" />
          </button>
        </div>
        ...
        <div className="font-bold text-xl">예약 가능한 시간</div>
        {/* 예약 시간 선택 */}
        ...
        <button
          type="button"
          className="absolute bottom-6 left-4 w-11/12 bg-green-80 rounded text-white text-center p-4 font-bold text-lg"
