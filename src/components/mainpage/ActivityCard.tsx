  ...
  return (
    <Link to={`/activity/${id}`} className="group h-[435px] md:h-[373px] sm:h-[295px]" target="_blank">
      <div className="flex flex-col gap-4">
        ...
        />
        <div className="flex flex-col gap-[10px] w-[282px] text-black leading-none group-hover:rounded-3xl group-hover:bg-blue-10 group-hover:text-blue-30 md:w-[221px] sm:w-[168px]">
          ...
          <div className="flex items-center gap-1 text-[28px] font-bold sm:text-xl sm:leading-none">
            {priceToWon(price)}
            <span className="text-xl text-gray-80 font-normal group-hover:text-blue-20 sm:text-base">/인</span>
          </div>
        </div>
      </div>
    </Link>
